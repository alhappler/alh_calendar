...
void main() {
  ...
  bool matchCalendarCellsBySixthRowDisabledAndOutOfRange({
    ...
    if (firstCalendarCell.isSixthRowAndDisabled ==
            secondCalendarCell.isSixthRowAndDisabled &&
        firstCalendarCell.isOutOfRange == secondCalendarCell.isOutOfRange) {
      return true;
    }
    return false;
  }
      ...
      for (int cell = 0; cell <= firstTableRow.children!.length - 1; cell++) {
        if (testSixthRowAndOutOfRange) {
          if (!matchCalendarCellsBySixthRowDisabledAndOutOfRange(
              ...
              secondCalendarCell:
                  secondTableRow.children![cell] as CalendarCell)) {
            return false;
          }
        } else {
  ...
  final expectedWeek1 = CalendarWeek(days: [
    CalendarDay(
  ...
  final expectedWeek2 = CalendarWeek(days: [
    CalendarDay(
  ...
  final expectedWeek3 = CalendarWeek(days: [
    CalendarDay(
  ...
  final expectedWeek4 = CalendarWeek(days: [
    CalendarDay(
  ...
  final expectedWeek5 = CalendarWeek(days: [
    CalendarDay(
  ...
  final expectedWeek6 = CalendarWeek(days: [
    CalendarDay(
  ...
  final givenCalendarMonth = CalendarMonth(month: expectedMonth, weeks: [
    expectedWeek1,
    expectedWeek2,
    expectedWeek3,
    expectedWeek4,
  ...
  group('#buildCurrentCalendarMonth', () {
    test(
      ...
      expect(actual.weeks[5] == expectedWeek6,
          isTrue); // should have only days from next month
    });
    ...
    test(
        'GIVEN forceSixWeekMonth is false and dateTime '
        'WHEN .buildCurrentCalendarMonth is called '
  ...
  group('buildCalendarTableRow', () {
    test(
        'GIVEN disableClickOutOfRange = true, selectedDateTime = 2022, 09, 26 '
        'WHEN .buildCalendarTableRow is called '
        'THEN should show expected TableRows with expected calendarCells, CalendarCell of selectedDateTime should be selected',
        () {
      // given
      const givenDisableClickOnOutOfRange = true;
      final givenSelectedDateTime = DateTime(2022, 09, 26);

      // when
      final actual = CalendarTableHelper.buildCalendarTableRow(
        calendarMonth: givenCalendarMonth,
        disableSixthRow: false,
        selectedDateTime: givenSelectedDateTime,
        dayBuilder: dayBuilder,
        onSelectDay: (DateTime dateTime) {},
        disableClickOnOutOfRange: givenDisableClickOnOutOfRange,
      );

      // then
      final expectedTableRow1 = TableRow(children: [
        CalendarCell(
      ...
      final expectedTableRow2 = TableRow(children: [
        CalendarCell(
      ...
      final expectedTableRow3 = TableRow(children: [
        CalendarCell(
      ...
      final expectedTableRow4 = TableRow(children: [
        CalendarCell(
      ...
      final expectedTableRow5 = TableRow(children: [
        CalendarCell(
      ...
      final expectedTableRow6 = TableRow(children: [
        CalendarCell(
          date: DateTime(2022, 10, 3),
          isInCurrentMonth: false,
          isSelected: false,
    ...
    test(
        'GIVEN disableSixthRow = true, maximumDateTime = 2022.10.4 and minimumDayTime = 2022.10.8 '
        'WHEN .buildCalendarTableRow is called '
        'THEN every cell in last row should have flag isSixthRowAndDisabled = true and '
        'the days 2022.10.4 and 2022.10.8 should have flag isOutOfRange = true, '
        'while all the others are flagged with = false ', () {
      // given
      const givenDisableSixthRow = true;
      final givenMinimumDayDate = DateTime(2022, 10, 4);
      final givenMaximumDayDate = DateTime(2022, 10, 8);

      // when
      final actual = CalendarTableHelper.buildCalendarTableRow(
        calendarMonth: givenCalendarMonth,
        disableSixthRow: givenDisableSixthRow,
        selectedDateTime: DateTime(2022, 09, 26),
        dayBuilder: dayBuilder,
        onSelectDay: (DateTime dateTime) {},
      ...
      final expectedTableRow = TableRow(children: [
        CalendarCell(
          date: DateTime(2022, 10, 3),
          isInCurrentMonth: false,
          isSelected: false,
