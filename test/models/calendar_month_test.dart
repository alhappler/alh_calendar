...
void main() {
  ...
  final givenCalendarMonth = CalendarMonth(month: DateTime(2022, 9), weeks: [
    CalendarWeek(days: [
      CalendarDay(
  ...
  test(
    ...
    // given
    final givenCalendarMonth2 = CalendarMonth(month: DateTime(2022, 9), weeks: [
      CalendarWeek(days: [
        CalendarDay(
  ...
  test(
      'GIVEN two non equal CalendarMonths and the second calendarMonth has more weeks'
      'WHEN == is called '
      'THEN should return false', () {
    // given
    final givenCalendarMonth2 = CalendarMonth(month: DateTime(2022, 9), weeks: [
